...
**1711–1776 · [empirisme](./empirisme.md)**
...
De tweede: begrens je conclusie. Alles wat je uit je metingen afleidt over een grotere groep, is een inductieve sprong. Daarom schrijf je op wie je onderzocht hebt en hoe ver je uitspraak reikt — dat is [externe validiteit](../spelregels/externe-validiteit.md) in de praktijk.

## Hangt samen met

- [De vork van Hume](./vork-van-hume.mdx) — analytisch tegenover synthetisch
- [Het inductieprobleem](./inductieprobleem.md) — de grens van wat waarneming je kan opleveren
- [Empirisme](./empirisme.md) — de stroming die hij tot zijn uiterste consequentie bracht
